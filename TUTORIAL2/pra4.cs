//4 : Input two number A and B. perform different operations using different operators and different data types available in C#.
//(Note : Follow all the operators and data types to do above task. Use Online help whenever necessary.)
